...
TCGA's pan-cancer study of germline variants etc.

```{r gene_predisposition, echo = T}

## load the data
gene_predisposition <- get_predisposition(cache_dir = "~/Desktop")

## number of cancer predisposition genes
nrow(gene_predisposition$records |> dplyr::filter(
  !stringr::str_detect(predisp_source, "^ACMG_SF$")
))
...
## load the data
gene_gencode <- get_gencode(cache_dir = "~/Desktop")
